<template>
  <div id="emojis">
    <div v-for="(emoji, index) in emojis" v-bind:key="index" class="emoji-card" :data-filter="emoji.type">
      ...
      <div class='emoji-images' v-emoji> {{ emoji.emojiImgs }} </div>
    <div class='emoji-card-title hide-card'>
      <a :href="emoji.itemLink">
        <h3>{{ emoji.title }}</h3>
      </a>
    </div>
    </div>
