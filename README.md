...
Note: The issues to add movies or shows have links to IMDB, but some have multiple versions. Feel free to add a different version than the link if you prefer.
